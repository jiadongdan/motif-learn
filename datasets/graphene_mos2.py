...
def get_layer_image(a=15, theta=0., size=512, center='mo', slide=(0, 0), A=0.5, n1=2, n2=2):
...
class GrapheneLattice:
    ...
    def to_image(self, n1=2, n2=2):
        # for graphene, A=1.0
        return get_layer_image(self.a, self.theta, self.size, self.center, self.slide, 1., n1, n2)
...
class MoS2Lattice:
    ...
    def to_image(self, A=0.5, n1=2, n2=2):
        return get_layer_image(self.a, self.theta, self.size, self.center, self.slide, A, n1, n2)
