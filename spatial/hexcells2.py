...
class Cell:
    ...
    def __init__(self, vertices, cell_label=None, pos=None, lbs=None, tform=None):
...
class HexCells:
    ...
    def __init__(self, pts, dx=0, dy=0):
        ...
        self.cells = self.pts[self.regions]
...
class ConnectedCells:
    ...
    def plot(self, ax=None):
        ...
        for cell in self.cells:
            ...
            ax.add_patch(poly)
        ax.scatter(self.pos[:, 0], self.pos[:, 1], c=mpl_21[self.lbs])
        ax.axis('equal')
