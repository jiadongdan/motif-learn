...
class HexCells:
    ...
    def __init__(self, pts, dx=0, dy=0):
        ...
        # in transformed image space, use _
        # get centers_
        ...
        self.centers_ = ij + [vmax // 2, vmax // 2]
    ...
    def get_connected_cells(self, min_area=3, max_area=10, colors=None):
        ...
        components = [self.image[e.slice] for e in region_props if np.logical_and(e.area >=min_area, e.area<=max_area)]
