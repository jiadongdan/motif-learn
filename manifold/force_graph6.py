...
@numba.njit(fastmath=True)
def optimize_stage(num_iterations, nodes, pairs, force_params, num_negative_samples, nbrs_ind, learning_rate, logs):
    num_nodes = len(nodes)
    lr = learning_rate
...
@numba.njit(fastmath=True)
def optimize_layout(num_iterations, nodes, pairs, num_negative_samples, nbrs_ind, learning_rate, force_params1, force_params2, divide):
    lr = learning_rate
    ...
    logs = optimize_stage(n_iter, nodes, pairs, force_params1, num_negative_samples, nbrs_ind, lr, logs)
    n_iter = int(num_iterations * (1 - divide))
    logs = optimize_stage(n_iter, nodes, pairs, force_params2, num_negative_samples, nbrs_ind, lr, logs)
    return logs
...
class ForceGraph6:
    ...
    def fit(self, X):
        ...
        self.logs = optimize_layout(self.num_iterations, self.nodes, self.pairs,
                                    ...
                                    self.force_params2, self.divide)
