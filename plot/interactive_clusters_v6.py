...
def get_angle(img1, img2):
    ...
    shifts, error, phasediff = register_translation(img1_rot, img2_rot, upsample_factor=20)
    return shifts[0]
...
class InteractiveCluster:
    ...
    def __init__(self, fig, X, img, pts, ps, lbs=None, clip=True, max_samples=15, **kwargs):
        self.fig = fig
...
def interactive_clusters(X, img, pts, ps, lbs=None, clip=True, max_samples=15, **kwargs):
    fig, ax = plt.subplots(1, 3, figsize=(12, 4))
    app = InteractiveCluster(fig, X, img, pts, ps, lbs, clip, max_samples, **kwargs)
    return app
