...
from ..feature.auto_clustering import seg_lbs
...
class InteractiveCluster:
    ...
    def __init__(self, fig, X, img, pts, ps, color_pts='red', s=5):
        self.fig = fig
        ...
        self.path_collection = self.ax_cluster.scatter(X[:, 0], X[:, 1], s=self.s, c=self.colors)
...
def interactive_clusters(X, img, pts, ps, color_pts='red'):
    fig, ax = plt.subplots(1, 3, figsize=(12, 4))
    app = InteractiveCluster(fig, X, img, pts, ps, color_pts)
    return app